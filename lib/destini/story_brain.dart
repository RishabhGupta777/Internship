...
class StoryBrain {
  ...
  List <Story> _storyData = [
    Story(
        storyTitle:'0:Your car has blown a tire on a winding road in the middle of nowhere with no cell phone reception. You decide to hitchhike. A rusty pickup truck rumbles to a stop next to you. A man with a wide brimmed hat with soulless eyes opens the passenger door for you and asks: "Need a ride, boy?".',
  ...
  //TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input which will be the choice number (int) made by the user.
    void nextStory(int userChoice){
      ...
      //When user is on story0 and they chose choice1, the story should progress to story2.
       if(userChoice==1 && _storyNumber==0) _storyNumber=2;
       else if(userChoice==2 && _storyNumber==0)_storyNumber = 1;

       else if(userChoice==1 && _storyNumber==2)_storyNumber = 5;
       else if(userChoice==2 && _storyNumber==2)_storyNumber = 4;

       else if(userChoice==1 && _storyNumber==1)_storyNumber = 2;
       else if(userChoice==2 && _storyNumber==1)_storyNumber = 3;
