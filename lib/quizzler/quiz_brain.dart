...
class Question{
  ...
  String questionText;
  bool questionAnswer;    //in property ko intialize constructor dwara kiya jaa raha h(in line 5)
}
...
class QuizBrain{
  ...
  List<Question>_questionBank = [    // agar iss class se bahar question ka list banate to syntax like Question questionBank=Question(q,r)  so _questionBank is our object
  ...
  String getQuestionText(){             // called Encapsulation
